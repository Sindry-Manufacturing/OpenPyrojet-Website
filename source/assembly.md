...
![aligning the backplane to the nozzle plate](images/assemblystep08.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep09.png)

Lay the silicon carbide monofilament along the heater row as shown, between the pieces of Kapton tape.  
![aligning the backplane to the nozzle plate](images/assemblystep10.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep11.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep12.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep13.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep14.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep15.png)
![aligning the backplane to the nozzle plate](images/assemblystep16.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep17.png)
![aligning the backplane to the nozzle plate](images/assemblystep18.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep19.png)
![aligning the backplane to the nozzle plate](images/assemblystep20.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep21.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep22.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep23.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep24.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep25.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep26.png)
![aligning the backplane to the nozzle plate](images/assemblystep27.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep28.png)
...
![aligning the backplane to the nozzle plate](images/assemblystep29.png)
![aligning the backplane to the nozzle plate](images/assemblystep30.png)
...
https://github.com/Sindry-Manufacturing/OpenPyroJet-Electronics

Adjoining firmware, UI and web-app interface can be found here, courtesy of Hayland.
https://github.com/Sindry-Manufacturing/OpenPyrojet-Jetpack
https://github.com/Sindry-Manufacturing/OpenPyrojet-Jetpack.js
